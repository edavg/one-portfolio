/* empty css                            */
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as renderComponent, j as renderHead, k as renderSlot, l as Fragment } from '../astro_CoP-hCFW.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_CSosBu2X.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_CSosBu2X.mjs'
    ).then(n => n.h).catch((e) => {
...
}, "D:/a/ed-one-portfolio/node_modules/astro/components/Image.astro", void 0);
...
}, "D:/a/ed-one-portfolio/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					const outDir = new URL("file:///D:/a/ed-one-portfolio/.vercel/output/static/");
...
}, "D:/a/ed-one-portfolio/src/components/nav.astro", void 0);
...
}, "D:/a/ed-one-portfolio/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es-PY"> <head><meta charset="UTF-8"><meta name="description" content="Astro description"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title>${renderComponent($$result, "ViewTransitions", $$ViewTransitions, {})}${renderHead()}</head> <body class="text-yellow-50 font-medium mt-12 max-w-screen-lg mx-auto w-11/12 antialiased selection:bg-yellow-50 selection:text-slate-800"> <header> ${renderComponent($$result, "Nav", $$Nav, {})} </header> <div class="fixed left-0 top-0 -z-10 h-full w-full"> <div class="relative h-full w-full bg-slate-950 bg-slate"> <div class="move absolute bottom-0 left-[0] top-[-10%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,rgba(69,87,189,0.15),rgba(255,255,255,0))]"></div><div class="move absolute bottom-0 hidden md:block right-[-0%] top-[-10%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,rgba(69,87,189,0.15),rgba(255,255,255,0))]"></div> </div> </div> <div class="relative animate-fade mt-36"> ${renderSlot($$result, $$slots["default"])} </div>  </body> </html>`;
}, "D:/a/ed-one-portfolio/src/layouts/Layout.astro", void 0);
...
}, "D:/a/ed-one-portfolio/src/components/projectData.astro", void 0);
...
const $$proyecto = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `Proyecto: ${info.title}` }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section${addAttribute(`view-transition-name: form`, "style")} class="max-w-3xl mx-auto"> <h1${addAttribute(`view-transition-name: title-${info.id} view-transition-name: title`, "style")} class="text-center font-bold text-4xl mb-12"> ${info.title} </h1> <div${addAttribute(`view-transition-name: svg-${info.id}`, "style")} class="flex gap-x-2 mb-6"> ${info.svg2 && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Image", $$Image, { "src": info.svg1, "loading": "eager", "height": 30, "width": 30, "alt": "" })} ${renderComponent($$result3, "Image", $$Image, { "src": info.svg2, "loading": "eager", "height": 30, "width": 30, "alt": "" })} ` })}`} ${info.svg3 && renderTemplate`${renderComponent($$result2, "Image", $$Image, { "src": info.svg3, "height": 30, "width": 30, "loading": "eager", "alt": "" })}`} </div> <p class="text-yellow-50">Click en la imagen para ir al sitio.</p> <a${addAttribute(info.link, "href")} target="_blank"> ${renderComponent($$result2, "Image", $$Image, { "width": 760, "height": 376, "src": info.image, "alt": `Proyecto: ${info.image}`, "loading": "eager", "class": "mx-auto lg:aspect-[600px/800px] rounded hover:shadow-xl transition-all hover:shadow-slate-800 cursor-pointer mb-6 shadow", "style": `view-transition-name: image-${info.id}` })} </a> <div class="bg-white bg-opacity-10 backdrop-blur-sm p-4 rounded-md shadow text-pretty"> <p${addAttribute(`view-transition-name: description-${info.id} view-transition-name: form`, "style")} class="text-lg mb-12"> ${info.description} </p> </div> </section> ` })}`;
}, "D:/a/ed-one-portfolio/src/pages/proyectos/[proyecto].astro", void 0);

const $$file = "D:/a/ed-one-portfolio/src/pages/proyectos/[proyecto].astro";
